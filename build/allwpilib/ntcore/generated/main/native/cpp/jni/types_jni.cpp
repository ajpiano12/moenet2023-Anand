...
{
  return MakeJObject(env, nt::GetAtomicRaw(subentry, CriticalJByteArrayRef{env, defaultValue}.uarray()));
}
...
{
  return MakeJObject(env, nt::GetAtomicIntegerArray(subentry, CriticalJLongArrayRef{env, defaultValue}));
}
  ...
  (JNIEnv* env, jclass, jint entry, jlong time, jlongArray value)
{
  ...
  return nt::SetIntegerArray(entry, CriticalJLongArrayRef{env, value}, time);
}
  ...
  (JNIEnv* env, jclass, jint entry, jlong, jlongArray defaultValue)
{
  ...
  return nt::SetDefaultIntegerArray(entry, CriticalJLongArrayRef{env, defaultValue});
}
...
{
  return MakeJObject(env, nt::GetAtomicFloatArray(subentry, CriticalJFloatArrayRef{env, defaultValue}));
}
  ...
  (JNIEnv* env, jclass, jint entry, jlong time, jfloatArray value)
{
  ...
  return nt::SetFloatArray(entry, CriticalJFloatArrayRef{env, value}, time);
}
  ...
  (JNIEnv* env, jclass, jint entry, jlong, jfloatArray defaultValue)
{
  ...
  return nt::SetDefaultFloatArray(entry, CriticalJFloatArrayRef{env, defaultValue});
}
...
{
  return MakeJObject(env, nt::GetAtomicDoubleArray(subentry, CriticalJDoubleArrayRef{env, defaultValue}));
}
  ...
  (JNIEnv* env, jclass, jint entry, jlong time, jdoubleArray value)
{
  ...
  return nt::SetDoubleArray(entry, CriticalJDoubleArrayRef{env, value}, time);
}
  ...
  (JNIEnv* env, jclass, jint entry, jlong, jdoubleArray defaultValue)
{
  ...
  return nt::SetDefaultDoubleArray(entry, CriticalJDoubleArrayRef{env, defaultValue});
}
