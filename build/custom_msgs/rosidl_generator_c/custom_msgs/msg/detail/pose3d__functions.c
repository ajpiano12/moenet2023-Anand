...
custom_msgs__msg__Pose3d__init(custom_msgs__msg__Pose3d * msg)
{
  ...
  // t
  if (!custom_msgs__msg__Translation3d__init(&msg->t)) {
    custom_msgs__msg__Pose3d__fini(msg);
    return false;
  }
  // r
  if (!custom_msgs__msg__Rotation3d__init(&msg->r)) {
    custom_msgs__msg__Pose3d__fini(msg);
    return false;
  }
  return true;
...
custom_msgs__msg__Pose3d__fini(custom_msgs__msg__Pose3d * msg)
{
  ...
  // t
  custom_msgs__msg__Translation3d__fini(&msg->t);
  // r
  custom_msgs__msg__Rotation3d__fini(&msg->r);
}
...
custom_msgs__msg__Pose3d__are_equal(const custom_msgs__msg__Pose3d * lhs, const custom_msgs__msg__Pose3d * rhs)
{
  ...
  // t
  if (!custom_msgs__msg__Translation3d__are_equal(
      &(lhs->t), &(rhs->t)))
  {
    return false;
  }
  // r
  if (!custom_msgs__msg__Rotation3d__are_equal(
      &(lhs->r), &(rhs->r)))
  {
    return false;
  }
