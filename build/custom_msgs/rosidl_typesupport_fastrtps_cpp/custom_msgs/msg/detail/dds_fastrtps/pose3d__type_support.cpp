...
#include "custom_msgs/msg/detail/pose3d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const custom_msgs::msg::Translation3d &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  custom_msgs::msg::Translation3d &);
...
{
bool cdr_serialize(
  const custom_msgs::msg::Rotation3d &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  custom_msgs::msg::Rotation3d &);
size_t get_serialized_size(
  const custom_msgs::msg::Rotation3d &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const custom_msgs::msg::Pose3d & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::Pose3d & ros_message)
{
  // Member: t
  ...
  size_t current_alignment)
{
  ...
  // Member: t
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        custom_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Translation3d(
  ...
  // Member: r
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        custom_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Rotation3d(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::Pose3d *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::Pose3d *>(
    untyped_ros_message);
...
static size_t _Pose3d__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Pose3d(full_bounded, is_plain, 0);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_Pose3d__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, Pose3d)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_Pose3d__handle;
}
